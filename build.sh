...
$JAVA_HOME/bin/javafxpackager -deploy -outdir examples/deploy/ -outfile UFXExample.dmg -name UFXExample -native dmg -appclass ExampleApp -srcfiles examples/website/builds/1.jar